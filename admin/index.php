...
<center><input class="inputsubmit" type="button" value="Usernames + E-Mails" onclick="javascript:document.location=&quot;ue.php&quot;;">&nbsp;&nbsp;<input class="inputsubmit" type="button" value="Ban Users" onclick="javascript:document.location=&quot;bu.php&quot;;">
<br><br>
<?php
include("../conn.php");

// Create connection(not needed cuz conn.php exists)
...
<tbody>
  <tr>
    ...
    <td class="tg-0pky"><?php echo htmlspecialchars($row["status"]); ?></td>
    <td class="tg-0pky"><?php echo htmlspecialchars($row["rank"]); ?></td>
    <td class="tg-0pky"><?php echo htmlspecialchars($row["date"]); ?></td>
