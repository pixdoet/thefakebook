...
?>
<html><head><title>Thefuckbook | Login</title>
      ...
      <table cellspacing="0" cellpadding="0" border="0" width="105">
        <tbody><tr><td>
              ...
              <tbody><tr><td align="right">
                  ...
                  </p><p><a href="register.php">[ register ]</a>
                  </p><p>
...
&nbsp;<center><p class="title">[ Login ]</p><p>
</p><form method="post" action="login.php">
<table cellspacing="0" cellpadding="2" border="0">
<tbody><tr><td>Email:</td>
    <td><input type="text" class="inputtext" name="email" id="email" value="" size="30"></td></tr>
<tr><td>Password:</td>
    <td><input type="password" class="inputtext" name="password" id="pass" size="30"></td></tr>
<tr height="7"><td></td><td></td></tr>
<tr><td><span style="color:red"><?php echo $login_status_text;?></span></td></tr>
</tbody></table>
