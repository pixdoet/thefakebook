                              ...
                              <tbody>
                                <tr>
                                  <td align="right">
                                    ...
                                    <form method="post" action="http://www.thefuckbook.ml/login.php">
                                      Email:<br>
                                      ...
                                      <center><input type="submit" class="inputsubmit" value="login">&nbsp;
                                        <input type="button" class="inputsubmit" value="register" onclick="javascript:document.location='http://www.thefuckbook.ml/register.php';">
                                      </center>
                                    </form>
                                    <!--<br>-->
                                  </td>
                        ...
                        <tr>
                          <td>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="2" border="0">
                              <tbody>
                                <tr>
                                  <td class="white" bgcolor="#3B5998">thefuckbook Privacy Policy</td>
                                </tr>
                              </tbody>
                            </table>
                            <center>
                                              ...
                                              <tr>
                                                <td>
                                                  <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                    <tbody>
                                                      <tr>
                                                        <td class="white" bgcolor="#3B5998">Coverage</td>
                                                      </tr>
                                                    </tbody>
                                                  </table>&nbsp;<br>
                                                  <center>
                                                    <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                      <tbody>
                                                        <tr>
                                                          <td>This privacy statement covers the site www.Thefakebook.ml. Because we want to
                                                            demonstrate our commitment to our users' privacy, we will disclose our information
                                                            and privacy practices below. <br>&nbsp;</td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                  </center>
                                                ...
                                                <tr>
                                                  <td>
                                                    <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                      <tbody>
                                                        <tr>
                                                          <td class="white" bgcolor="#3B5998">About Thefakebook and the Information We Collect</td>
                                                        </tr>
                                                      </tbody>
                                                    </table>&nbsp;<br>
                                                    <center>
                                                      <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                        <tbody>
                                                          <tr>
                                                            <td>Thefakebook is an online directory and social networking community that helps
                                                              ...
                                                              displayed to people in the groups specified in the users' privacy settings. <br>&nbsp;</td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                    </center>
                                                  ...
                                                  <tr>
                                                    <td>
                                                      <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                        <tbody>
                                                          <tr>
                                                            <td class="white" bgcolor="#3B5998">Information Collected by Thefakebook</td>
                                                          </tr>
                                                        </tbody>
                                                      </table>&nbsp;<br>
                                                      <center>
                                                        <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                          <tbody>
                                                            <tr>
                                                              <td>Thefakebook collects user-submitted account information such as name and email
                                                                address to identify users and send notifications related to use of the site.
                                                                Thefakebook also collects user-submitted profile information such as gender,
                                                                field, location, courses, etc.
                                                                <p>Thefakebook also collects information that is not personally identifiable and
                                                                ...
                                                                <p>Thefakebook collects information from other sources, such as newspapers and
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                          <tbody>
                                                            <tr>
                                                              <td class="white" bgcolor="#3B5998">Use of Information Obtained by Thefakebook</td>
                                                            </tr>
                                                          </tbody>
                                                        </table>&nbsp;<br>
                                                        <center>
                                                          <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                            <tbody>
                                                              <tr>
                                                                <td>Profile information, as well as name, email and photo, are displayed to people in the
                                                                  ...
                                                                  never be given to anyone outside the site. No information submitted to Thefakebook
                                                                  ...
                                                                  <p>We use server, IP and browser type for site administration. We also use information
                                                                    not directly submitted to Thefakebook by users to supplement users' profiles unless
                                                                    they specify that they do not want this done in their privacy settings. <br>&nbsp;</p>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                            <tbody>
                                                              <tr>
                                                                <td class="white" bgcolor="#3B5998">Spam Policy</td>
                                                              </tr>
                                                            </tbody>
                                                          </table>&nbsp;<br>
                                                          <center>
                                                            <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                              <tbody>
                                                                <tr>
                                                                  <td>Email addresses will never be sold to anyone, and they will not be used for spam or
                                                                    any other purpose outside of the site itself. <br>&nbsp;</td>
                                                                </tr>
                                                              </tbody>
                                                            </table>
                                                          </center>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                              <tbody>
                                                                <tr>
                                                                  <td class="white" bgcolor="#3B5998">Links</td>
                                                                </tr>
                                                              </tbody>
                                                            </table>&nbsp;<br>
                                                            <center>
                                                              <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                <tbody>
                                                                  <tr>
                                                                    <td>This site may contain links to other websites. Thefakebook is not responsible for
                                                                      ...
                                                                      to information collected by this web site. <br>&nbsp;</td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                                            </center>
                                                          ...
                                                          <tr>
                                                            <td>
                                                              <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                                <tbody>
                                                                  <tr>
                                                                    <td class="white" bgcolor="#3B5998">Use of Cookies</td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>&nbsp;<br>
                                                              <center>
                                                                <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                  <tbody>
                                                                    <tr>
                                                                      <td>A cookie is a piece of data stored on the user's computer tied to information about
                                                                        ...
                                                                        private information from any user. <br>&nbsp;</td>
                                                                    </tr>
                                                                  </tbody>
                                                                </table>
                                                              </center>
                                                            ...
                                                            <tr>
                                                              <td>
                                                                <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                                  <tbody>
                                                                    <tr>
                                                                      <td class="white" bgcolor="#3B5998">Third Party Advertising</td>
                                                                    </tr>
                                                                  </tbody>
                                                                </table>&nbsp;<br>
                                                                <center>
                                                                  <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                    <tbody>
                                                                      <tr>
                                                                        <td>Advertisements that appear on this web site are delivered to users by our advertising
                                                                          ...
                                                                          of most interest to you. Thefakebook does not have access to or control of the cookies
                                                                          that may be placed by the third party advertising servers of ad networks.
                                                                          <p>This privacy statement covers the use of cookies by Thefakebook and does not cover
                                                                            the use of cookies by any of its advertisers. <br>&nbsp;</p>
                                                                        </td>
                                                                      </tr>
                                                                    </tbody>
                                                                  </table>
                                                              ...
                                                              <tr>
                                                                <td>
                                                                  <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                                    <tbody>
                                                                      <tr>
                                                                        <td class="white" bgcolor="#3B5998">Changing or Removing Information</td>
                                                                      </tr>
                                                                    </tbody>
                                                                  </table>&nbsp;<br>
                                                                  <center>
                                                                    <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                      <tbody>
                                                                        <tr>
                                                                          <td>Thefakebook users may modify or remove any of their personal information at any time
                                                                            by logging into their account. Information will be updated immediately and old
                                                                            information will never be displayed to any user of the site. <br>&nbsp;</td>
                                                                        </tr>
                                                                      </tbody>
                                                                    </table>
                                                                  </center>
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                                      <tbody>
                                                                        <tr>
                                                                          <td class="white" bgcolor="#3B5998">Security</td>
                                                                        </tr>
                                                                      </tbody>
                                                                    </table>&nbsp;<br>
                                                                    <center>
                                                                      <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                        <tbody>
                                                                          <tr>
                                                                            <td>Thefakebook accounts are password-protected. This web site takes every precaution to
                                                                              ...
                                                                              please <a href="contact.php">contact us</a>. <br>&nbsp;</td>
                                                                          </tr>
                                                                        </tbody>
                                                                      </table>
                                                                    </center>
                                                                  ...
                                                                  <tr>
                                                                    <td>
                                                                      <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                                        <tbody>
                                                                          <tr>
                                                                            <td class="white" bgcolor="#3B5998">Changes in Our Privacy Policy</td>
                                                                          </tr>
                                                                        </tbody>
                                                                      </table>&nbsp;<br>
                                                                      <center>
                                                                        <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                          <tbody>
                                                                            <tr>
                                                                              <td>We reserve the right to change our privacy policy at any time. If we do this, we will post
                                                                                ...
                                                                                the time of collection, we will notify users via email. <br>&nbsp;</td>
                                                                            </tr>
                                                                          </tbody>
                                                                        </table>
                                                                      </center>
                                                                    ...
                                                                    <tr>
                                                                      <td>
                                                                        <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                                                          <tbody>
                                                                            <tr>
                                                                              <td class="white" bgcolor="#3B5998">Contacting the Web Site</td>
                                                                            </tr>
                                                                          </tbody>
                                                                        </table>&nbsp;<br>
                                                                        <center>
                                                                          <table width="95%" cellspacing="0" cellpadding="2" border="0">
                                                                            <tbody>
                                                                              <tr>
                                                                                <td>If you have any questions about this privacy statement, the practices of this site, or
                                                                                  your dealings with this web site, please <a href="contact.php">contact us</a>. <br>&nbsp;</td>
                                                                              </tr>
                                                                            </tbody>
                                                                          </table>
                                                                        </center>
