...
<head>
  <title>Thefakebook | Registration</title>
                                                          ...
                                                          <td>
                                                            <table cellspacing="0" cellpadding="2" border="0">
                                                              <tbody>
                                                                <tr>
                                                                  <td>Name:</td>
                                                                  <td><input type="text" class="inputtext" required name="name" value="" size="30"></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>Status:</td>
                                                                ...
                                                                <tr>
                                                                  <td>Email:</td>
                                                                  <td><input type="email" class="inputtext" name="email" required value="" size="30"></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>Password*: (choose)&nbsp;</td>
                                                                  <td><input type="password" class="inputtext" required name="password" size="30"></td>
                                                                </tr>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <table cellspacing="0" cellpadding="3" border="0">
                                                              <tbody>
                                                                <tr>
                                                                  <td><input type="checkbox" required name="terms" value="1"></td>
                                                                  <td>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td>You can choose any password. <font color="red">It
                                                                      should not be your password that you use frequently in other sites.</font>
                                                                  </td>
                                                                </tr>
                                                              </tbody>
                                                            </table>
